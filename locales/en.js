const en = {
  ...
  __COMPLETION_WEB_SEARCH: (q, d = '') => `${d ? `Date: ${d}\n` : ''}Use web search to answer "${q}" briefly in plain text without any markdown or link syntax.`,
  __COST_FOOTER: (yen) => `This reply cost about ¥${yen}`,
