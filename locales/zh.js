const zh = {
  ...
  __COMMAND_BOT_DRAW_DEMO_TEXT: '/draw 貓咪',
  ...
  __COMMAND_BOT_SEARCH_DEMO_TEXT: '/search 日期',
  ...
  __COMPLETION_WEB_SEARCH: (q, d = '') => `${d ? `日期：${d}\n` : ''}請使用網路搜尋，簡潔回答「${q}」。請使用純文字，不要使用Markdown或連結語法。`,
  ...
  __ERROR_INVALID_CREDENTIALS: '請檢查外部服務的認證設定。',
